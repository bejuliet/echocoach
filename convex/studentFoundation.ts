...
const INITIAL_CLASSES: ClassSeed[] = [
  ...
  {
    classId: "class_Broady",
    displayName: "Broady Class",
    memberStudentIds: ["stu_Broady"],
    classType: "1:1",
    status: "Active",
    cycle: "Weekly",
  },
  {
    classId: "class_Claire",
    displayName: "Claire Class",
    memberStudentIds: ["stu_Claire"],
    classType: "1:1",
    status: "Active",
    cycle: "Weekly",
  },
  {
    classId: "class_Irina",
    displayName: "Irina Class",
    memberStudentIds: ["stu_Irina"],
    classType: "1:1",
    status: "Active",
    cycle: "Weekly",
  },
  {
    classId: "class_Jonathan",
    displayName: "Jonathan Class",
    memberStudentIds: ["stu_Jonathan"],
    classType: "1:1",
    status: "Active",
    cycle: "Weekly",
  },
  {
    classId: "class_Ethan",
    displayName: "Ethan Class",
    memberStudentIds: ["stu_Ethan"],
    classType: "1:1",
    status: "Active",
    cycle: "Weekly",
  },
